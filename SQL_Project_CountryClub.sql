...
Select Count(name) as Zero_fee from Facilities
Where membercost =0 ;
...
Select facid, name, membercost, monthlymaintenance as Zero_fee from Facilities
...
SELECT CONCAT(firstname, " ", surname) AS Full_Name, F.name as Court_Name
